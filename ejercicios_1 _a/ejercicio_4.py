...
jornada_laboral = int(input("Ingrese la cantidad de horas de 1 jornada laboral => "))
salario = (jornada_laboral*valor_hora*5)+((jornada_laboral/2)*valor_hora)
print(f"El valor del salario semanal para {jornada_laboral} hs diarias es : ${salario}")