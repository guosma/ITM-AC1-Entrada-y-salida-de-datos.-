...
nombre_socio_2 = input("ingrese el nombre del segundo socio: ")
aporte_socio_2 = int(input("ingrese el monto aportado por el prmer socio => "))

nombre_socio_3 = input("ingrese el nombre del tercer socio: ")
...
print(f"""El capital total aportado es : {capital_total}
El Socio {nombre_socio_1} aporto {porcentage_socio_1}%
El Socio {nombre_socio_2} aporto {porcentage_socio_2}%
El Socio {nombre_socio_3} aporto {porcentage_socio_3}%
"""
)